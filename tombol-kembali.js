...
function buatTombolKembali() {
    ...
    tombol.addEventListener('click', function() {
        ...
        // Untuk repository Landing-page
        if (seg.length === 0 || seg[0] === 'Landing-page') {
...
function init() {
    ...
    if (isIndexPage) {
        ...
        console.log('✅ Halaman utama (Landing-pag/): menampilkan tombol laporan');
        buatTombolLaporan();
